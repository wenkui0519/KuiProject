...
import { ControlAttributeService } from '../control-attribute/control-attribute.service';
            ...
            editor.on('click', (e) => {
                ...
                angular.forEach(allElement, (data, index) => {
                    if (data && data.id) {
                        ...
                        this.attributeService.controlCount = 0
                    }
                });
                ...
                if ($element.attr('data-efb-control')) {
                    ...
                    this.ngZone.run(_ => {
                        ...
                        this.controlAttributeService.setAttributes$.next(attributes);
